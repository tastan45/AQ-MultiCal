...
st.set_page_config(page_title="Machine Learning-Based Air Quality Sensor Calibration Platform", layout="wide", initial_sidebar_state="expanded")

# --- Custom CSS Styles (For Professional Look) ---
st.title("🔬 Machine Learning-Based Air Quality Sensor Calibration Platform")
